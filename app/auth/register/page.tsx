    ...
    <div className="container flex h-screen w-full flex-col items-center justify-center px-4 md:px-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col space-y-2 text-center">
          ...
          <p className="text-sm text-cool-gray">Enter your email below to create your account</p>
        </div>
        ...
        <p className="px-8 text-center text-sm text-cool-gray">
          ...
          <Link href="/auth/login" className="hover:text-deep-red underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </motion.div>
